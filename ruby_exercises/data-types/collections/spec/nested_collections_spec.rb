RSpec.describe 'Nested Collections' do
  ...
  it 'test 2' do
    ...
    thirty_nine = coordinates.fetch(2)
    thirty_nine = thirty_nine.last
  ...
  it 'test 7' do
    ...
    add_pitcher = team.fetch(:pitchers)
    add_pitcher.push("Phil")
    team[:pitchers] = add_pitcher
  ...
  it 'test 15' do
    ...
    actual = three_day_forecast.dig(:days, 1, :high)
    expected = 55
    expect(actual).to eq(expected)
  end
  ...
  it 'test 17' do
    ...
    actual = three_day_forecast.dig(:days, 2).values
